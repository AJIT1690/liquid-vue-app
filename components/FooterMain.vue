		...
		<div class="container">
			<div class="top-footer">
				...
				<div class="link-box">
					<div class="address">
						<h6>Contact</h6>
						<p>Level 22, 120 Spencer Street, Melbourne, VIC 3000, Australia +61 383 945 476</p>
					</div>
					<div class="address">
						<h6>WhatsApp</h6>
						<p>+61 498 544 763<br>(WhatsApp calls only)</p>
					</div>
			...
			<div class="bottom-footer">
				<p class="left-links"><a href="#">Privacy</a> | <a href="#">Disclaimer</a> | <a href="#">Terms of Use</a> | <a href="#">Browser Requirements</a> </p>
				<p class="right-links">Copyright © 2019 Property Prosper  | <a href="#">Powered by Portal.co</a> </p>
			</div>
